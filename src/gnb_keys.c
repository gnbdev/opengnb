...
int gnb_load_keypair(gnb_core_t *gnb_core){
    ...
    snprintf(node_private_file_name, PATH_MAX+NAME_MAX, "%s/security/%"PRIu64".private", gnb_core->conf->conf_dir, gnb_core->conf->local_uuid);
    snprintf(node_public_file_name,  PATH_MAX+NAME_MAX, "%s/security/%"PRIu64".public",  gnb_core->conf->conf_dir, gnb_core->conf->local_uuid);
...
int gnb_load_public_key(gnb_core_t *gnb_core, uint64_t uuid64, unsigned char *public_key){
    ...
    snprintf(node_public_file_name, PATH_MAX+NAME_MAX, "%s/ed25519/%"PRIu64".public", gnb_core->conf->conf_dir, uuid64);
